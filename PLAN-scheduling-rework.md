...
### Bugs to Fix
- [ ] in the reservation list, if the "duree" of a remplacement is less than a mpnth or not a full mont hvalue, the duree is not correct (eg ig the remplacement is for 15 days, duree = 0 months)
